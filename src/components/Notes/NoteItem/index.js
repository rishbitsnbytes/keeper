...
const NoteItem = ({ note }) => {
  ...
  const handleDeleteArchivedNote = async () => {
    ...
    try {
      ...
      showToast("Could note delete note. Try again after sometime!", "error");
    }
  };
  ...
  const handleDeleteNote = async () => {
    ...
    try {
      ...
      showToast("Could note delete note. Try again after sometime!", "success");
      setIsOngoingCall(false);
    }
  };
  ...
  const handleRestoreTrashedNote = async () => {
    ...
    try {
      ...
      showToast("Could not restore note from trash. Try again later.", "error");
      setIsOngoingCall(false);
    }
  };
  ...
  const handleDeleteTrashedNoteForever = async () => {
    ...
    try {
      ...
      showToast("Could not delete note from trash. Try again later.", "error");
      setIsOngoingCall(false);
    }
  };
